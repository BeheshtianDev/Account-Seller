  ...
  return (
    <div className=" w-full flex justify-start flex-col items-center h-auto relative ">
      <div className="h-screen w-full flex flex-col gap-2 justify-start items-center relative overflow-hidden ">
        ...
        <div className="w-[130vw] h-[105vw] rounded-[50%]  bg-orange-700 absolute lg:opacity-40 opacity-80 lg:-bottom-[78vw] md:-bottom-[70vw] -bottom-[40vw]  blur-[50px] z-10"></div>
        ...
        {/* content start */}
        <div className="w-full flex justify-between items-start px-14 pt-7 z-30">
          <div className="w-40">
            <button className="w-12 h-12 rounded-full relative flex justify-center items-center bg-gradient-to-br   border border-white/10 shadow-xl shadow-black/20 backdrop-blur-lg backdrop-brightness-200  from-white/10 from-10%  to-transparent to-60%">
              <Image
                src="/home-icon.svg"
                alt=""
                width={25}
        ...
        <span className="lg:text-[3.5vw] text-[6vw] text-center  mt-28 ">
